...
# Temporary until weird behavior when using -O and -O2 directly is fixed.
# Manually specifying optimization flags from the manual is not the same as using -O flags directly
