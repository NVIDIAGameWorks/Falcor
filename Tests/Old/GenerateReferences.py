...
def main():
    ...
    # Add argument for specifying to only build local instead of dispatching to teamcity
    parser.add_argument('-nr', '--no_rebuild', action='store_true', help='Build the solution instead of rebuilding it')
    ...
    # Add argument for specifying specific git url. shouldn't do this unless
