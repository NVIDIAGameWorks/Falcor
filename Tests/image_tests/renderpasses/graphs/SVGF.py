...
def render_graph_SVGF():
    ...
    PathTracer = RenderPass("MegakernelPathTracer", {'mSharedParams': PathTracerParams(useVBuffer=0, clampThreshold=10.000000, samplesPerPixel=1, useAnalyticLights=1, maxBounces=3, forceAlphaOne=1, clampSamples=0, useEmissiveLights=1, useEnvLight=1, useBRDFSampling=1, useEnvBackground=1, useMIS=1, misHeuristic=1, misPowerExponent=2.000000, useEmissiveLightSampling=1, probabilityAbsorption=0.200000, useRussianRoulette=0, useFixedSeed=0), 'mSelectedSampleGenerator': 0, 'mSelectedEmissiveSampler': EmissiveLightSamplerType.Uniform})
