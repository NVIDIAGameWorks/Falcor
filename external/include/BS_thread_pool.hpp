...
public:
     ...
     */
    template <typename F, typename T1, typename T2, typename T = std::common_type_t<T1, T2>, typename R = std::invoke_result_t<std::decay_t<F>, T, T>, std::enable_if_t<std::is_invocable_v<std::decay_t<F>, T, T>, bool> = true>
