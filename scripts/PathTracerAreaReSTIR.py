...
def render_graph_PathTracerAreaReSTIR():
    g = RenderGraph("PathTracerAreaReSTIR")
    PathTracer = createPass("PathTracer", {
        ...
        'reSTIRPathTracingOptions': {'useAreaReservoirs': True}
    })
...
PathTracerAreaReSTIR = render_graph_PathTracerAreaReSTIR()
try: m.addGraph(PathTracerAreaReSTIR)
