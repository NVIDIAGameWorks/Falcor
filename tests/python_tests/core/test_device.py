    ...
    def test_create(self):
        for device_type in DEVICE_TYPES:
            with self.subTest():
                ...
                print(f"max_compute_dispatch_thread_groups={device.limits.max_compute_dispatch_thread_groups}")
                print(f"max_shader_visible_samplers={device.limits.max_shader_visible_samplers}")
